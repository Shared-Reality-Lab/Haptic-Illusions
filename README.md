...
|<img align="center" width="400" src="images/Shape illusion/shape_illusion.png"><br/>Elevation Illusion|1 x came.stl<br/>2 x galet.stl|Came.stl should be printed on its side and should not require any support structures. galet.stl should be printed on its side and should be printed with supports.|<img align="center" width="400" src="image/layout/shape_illusion.png">|
